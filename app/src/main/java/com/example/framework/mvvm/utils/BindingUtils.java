package com.example.framework.mvvm.utils;
...
import com.example.framework.mvvm.ui.feed.opensource.OpenSourceItemViewModel;
import com.example.framework.mvvm.ui.home.news.NewsAdapter;
import com.example.framework.mvvm.ui.main.MainViewModel;
import com.example.framework.mvvm.ui.main.QuestionCard;
...
public final class BindingUtils {
    ...
    @BindingAdapter({"adapter"})
    public static void addNewsItems(RecyclerView recyclerView, List<NewsItemResponse> news) {
